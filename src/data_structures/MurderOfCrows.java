...
public class MurderOfCrows {
	...
	private void findTheDiamond() {
		 ...
		 */
		boolean foundDiamond =new Boolean(false);
		/* 2. How many innocent crows had to die before the diamond was found? */
		for (int i = 0; i < theMurder.size(); i++) {
			ArrayList<String> x =theMurder.get(i).getStomachContents();
			...
			if(foundDiamond == false) {
				System.out.println(theMurder.get(i).getName() + " did not have the diamond");
			}
